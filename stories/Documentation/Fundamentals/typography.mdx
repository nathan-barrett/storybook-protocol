...
import { specimens } from "/helpers/config.js";


<Meta title="Documentation / Fundamentals / Typography" />
...
<figure id="specimen-inter" className="docs-specimen docs-specimen-font">
  <strong>{ specimens.alphabet }</strong><br/>
  { specimens.alphabet }<br/>
  { specimens.characters }<br/>
  { specimens.digits }<br/>
  { specimens.punctuation }<br/>
  { specimens.special }<br/>
  { specimens.math }
</figure>
...
<figure id="specimen-zilla-slab" className="docs-specimen docs-specimen-font">
  <strong>{ specimens.alphabet }</strong><br/>
  { specimens.alphabet }<br/>
  { specimens.characters }<br/>
  { specimens.digits }<br/>
...
<figure id="specimen-metropolis" className="docs-specimen docs-specimen-font">
  <strong>{ specimens.alphabet }</strong><br/>
  { specimens.alphabet }<br/>
  { specimens.characters }<br/>
  { specimens.digits }<br/>
...
<div id="specimen-type-scale" className="docs-specimen">
  <span className="docs-scale-sample docs-scale-sample-title-2xl">Title 2XL</span>
  <span className="docs-scale-sample docs-scale-sample-title-xl">Title XL</span>
  <span className="docs-scale-sample docs-scale-sample-title-lg">Title LG</span>
  <span className="docs-scale-sample docs-scale-sample-title-md">Title MD</span>
  <span className="docs-scale-sample docs-scale-sample-title-sm">Title SM</span>
  <span className="docs-scale-sample docs-scale-sample-title-xs">Title XS</span>
  <span className="docs-scale-sample docs-scale-sample-title-2xs">Title 2XS</span>
  <span className="docs-scale-sample docs-scale-sample-title-3xs">Title 3XS</span>
  <span className="docs-scale-sample docs-scale-sample-body-xl">Body XL</span>
  <span className="docs-scale-sample docs-scale-sample-body-lg">Body LG</span>
  <span className="docs-scale-sample docs-scale-sample-body-md">Body MD</span>
  <span className="docs-scale-sample docs-scale-sample-body-sm">Body SM</span>
  <span className="docs-scale-sample docs-scale-sample-body-xs">Body XS</span>
</div>
...
<div id="specimen-type-scale-condensed" className="docs-specimen">
  <span className="docs-scale-sample docs-scale-sample-title-2xl">Title 2XL</span>
  <span className="docs-scale-sample docs-scale-sample-title-xl">Title XL</span>
  <span className="docs-scale-sample docs-scale-sample-title-lg">Title LG</span>
  <span className="docs-scale-sample docs-scale-sample-title-md">Title MD</span>
